...
async function getLighthouseDriver(session, target) {
    ...
    const connection = new cri_1.default(cUrl.port, cUrl.hostname);
    /**
    ...
    if (!cUrl.pathname.startsWith('/devtools/browser')) {
        ...
        const { sessionId } = await connection.sendCommand('Target.attachToTarget', undefined, { targetId: target._targetId, flatten: true });
        connection.setSessionId(sessionId);
        return new driver_1.default(connection);
    }
